...
package math.optimization.general;

import math.analysis.DifferentiableMultivariateVectorFunction;
import math.analysis.FunctionUtils;
import math.analysis.differentiation.DerivativeStructure;
import math.analysis.differentiation.MultivariateDifferentiableVectorFunction;
...
import math.linear.ArrayRealVector;
import math.linear.RealMatrix;
import math.linear.DiagonalMatrix;
import math.linear.DecompositionSolver;
import math.linear.MatrixUtils;
import math.linear.QRDecomposition;
import math.linear.EigenDecomposition;
import math.optimization.OptimizationData;
import math.optimization.InitialGuess;
import math.optimization.Target;
import math.optimization.Weight;
import math.optimization.ConvergenceChecker;
import math.optimization.DifferentiableMultivariateVectorOptimizer;
import math.optimization.PointVectorValuePair;
import math.optimization.direct.BaseAbstractMultivariateVectorOptimizer;
 ...
 * analysis.MultivariateVectorFunction,OptimizationData[])
 ...
 * {@link optimization.Target Target} while
 * the number of columns is equal to the dimension of the
 * {@link optimization.InitialGuess InitialGuess}.
 *
...
public abstract class AbstractLeastSquaresOptimizer
     ...
     * optimization.SimpleVectorValueChecker}.
     * @deprecated See {@link optimization.SimpleValueChecker#SimpleValueChecker()}
     */
    @Deprecated
     ...
     * problem dimension.
     * @throws exception.TooManyEvaluationsException
     ...
     * @throws linear.SingularMatrixException
     ...
     * @throws exception.DimensionMismatchException
     * if the start point dimension is wrong.
     * @throws exception.TooManyEvaluationsException
     * if the maximal number of evaluations is exceeded.
     * @throws exception.NullArgumentException if
     ...
     * function.
     * @throws exception.TooManyEvaluationsException if
