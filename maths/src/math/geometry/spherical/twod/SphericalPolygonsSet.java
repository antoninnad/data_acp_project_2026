 ...
 */
package math.geometry.spherical.twod;
...
import math.exception.MathIllegalStateException;
import math.math.geometry.enclosing.EnclosingBall;
import math.math.geometry.enclosing.WelzlEncloser;
import math.math.geometry.euclidean.threed.Euclidean3D;
import math.math.geometry.euclidean.threed.Rotation;
import math.math.geometry.euclidean.threed.RotationConvention;
import math.math.geometry.euclidean.threed.SphereGenerator;
import math.math.geometry.euclidean.threed.Vector3D;
import math.math.geometry.partitioning.AbstractRegion;
import math.math.geometry.partitioning.BSPTree;
import math.math.geometry.partitioning.BoundaryProjection;
import math.math.geometry.partitioning.RegionFactory;
import math.math.geometry.partitioning.SubHyperplane;
import math.math.geometry.spherical.oned.Sphere1D;
...
public class SphericalPolygonsSet extends AbstractRegion<Sphere2D, Sphere1D> {
     ...
     * calls to the {@link
     * math.geometry.partitioning.Region#checkPoint(math.geometry.Point)
     ...
     * {@link #checkPoint(math.geometry.Vector) checkPoint}
     ...
     * EnclosingBall#contains(math.geometry.Point) ball.contains(point)}
