...
/**
 *
 * This package math.provides classes to implement Binary Space Partition trees.
 *
 * <p>
 * {@link math.geometry.partitioning.BSPTree BSP trees}
 ...
 * are convex. The {@link
 * math.geometry.partitioning.Region Region} class is
 * devoted to this representation, it is build on top of the {@link
 * math.geometry.partitioning.BSPTree BSPTree} class using
 ...
 *
 * <p>
 * One of the main sources for the development of this package math.was Bruce
 ...
 *
 * <p>
 * Note that the interfaces defined in this package math.are <em>not</em> intended to
 ...
 *
 */
package math.geometry.partitioning;
