 ...
 */
package math.geometry.euclidean.threed;
...
import math.math.geometry.Point;
import math.math.geometry.euclidean.oned.Euclidean1D;
import math.math.geometry.euclidean.twod.Euclidean2D;
import math.math.geometry.euclidean.twod.PolygonsSet;
import math.math.geometry.euclidean.twod.SubLine;
import math.math.geometry.euclidean.twod.Vector2D;
import math.math.geometry.partitioning.AbstractRegion;
import math.math.geometry.partitioning.BSPTree;
import math.math.geometry.partitioning.BSPTreeVisitor;
import math.math.geometry.partitioning.BoundaryAttribute;
import math.math.geometry.partitioning.Hyperplane;
import math.math.geometry.partitioning.Region;
import math.math.geometry.partitioning.RegionFactory;
import math.math.geometry.partitioning.SubHyperplane;
import math.math.geometry.partitioning.Transform;
    ...
    private static class RotationTransform implements Transform<Euclidean3D, Euclidean2D> {
        ...
        public SubHyperplane<Euclidean2D> apply(final SubHyperplane<Euclidean2D> sub,
            ...
            if (original != cachedOriginal) {
                ...
                cachedTransform =
                        math.geometry.euclidean.twod.Line.getTransform(tP10.getX() - tP00.getX(),
                                                                                           tP10.getY() - tP00.getY(),
                                                                                           tP01.getX() - tP00.getX(),
                                                                                           tP01.getY() - tP00.getY(),
                                                                                           tP00.getX(),
    ...
    private static class TranslationTransform implements Transform<Euclidean3D, Euclidean2D> {
        ...
        public SubHyperplane<Euclidean2D> apply(final SubHyperplane<Euclidean2D> sub,
            ...
            if (original != cachedOriginal) {
                ...
                cachedOriginal  = (Plane) original;
                cachedTransform =
                        math.geometry.euclidean.twod.Line.getTransform(1, 0, 0, 1,
                                                                                           shift.getX(),
                                                                                           shift.getY());
