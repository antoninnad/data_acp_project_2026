...
public abstract class BaseAbstractUnivariateIntegrator implements UnivariateIntegrator {
     ...
     */
    @Deprecated
    protected math.util.Incrementor iterations;
     ...
     *       like {@link util.Precision#SAFE_MIN Precision.SAFE_MIN}.</li>
    ...
    protected BaseAbstractUnivariateIntegrator(final double relativeAccuracy,
        ...
        math.util.Incrementor wrapped =
        		math.util.Incrementor.wrap(count);
