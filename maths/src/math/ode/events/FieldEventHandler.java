...
import math.ode.FieldODEState;
import math.ode.FieldODEStateAndDerivative;
...
public interface FieldEventHandler<T extends RealFieldElement<T>>  {
     ...
     * ode.sampling.FieldStepHandler FieldStepHandler} method {@link
     * ode.sampling.FieldStepHandler#handleStep(
     * ode.sampling.FieldStepInterpolator, boolean)
     ...
     * {@link ode.sampling.FieldStepHandler FieldStepHandler}
     ...
     * ode.sampling.FieldStepHandler variable step handlers}.</p>
