...
public interface EventHandler  {
    ...
    enum Action {
         ...
         * ode.FirstOrderDifferentialEquations#computeDerivatives}
         * method).</p>
         */
        RESET_DERIVATIVES,
   ...
   * otherwise {@link exception.NoBracketingException
   ...
   *   ode.sampling.StepHandler#handleStep handleStep}
   ...
   * ode.sampling.StepHandler StepHandler} method {@link
   * ode.sampling.StepHandler#handleStep(
   * ode.sampling.StepInterpolator, boolean)
   ...
   * ode.sampling.StepHandler variable step handlers} and
   * to the size of the fixed step for {@link
   * ode.sampling.FixedStepHandler fixed step handlers}.</p>
