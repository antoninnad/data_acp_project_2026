...
import math.analysis.solvers.BracketingNthOrderBrentSolver;
...
import math.ode.events.EventHandler;
import math.ode.events.EventState;
import math.ode.sampling.AbstractStepInterpolator;
import math.ode.sampling.StepHandler;
import math.util.FastMath;
import math.util.IntegerSequence;
...
public abstract class AbstractIntegrator implements FirstOrderIntegrator {
     ...
     */
    @Deprecated
    protected math.util.Incrementor getEvaluationsCounter() {
        return math.util.Incrementor.wrap(evaluations);
    }
