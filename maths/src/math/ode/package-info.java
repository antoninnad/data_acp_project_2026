 ...
 *
 * <p>
 * This package math.provides classes to solve Ordinary Differential Equations problems.
 * </p>
 *
 * <p>
 * This package math.solves Initial Value Problems of the form
 ...
 * ode.sampling.StepInterpolator StepInterpolator}
 ...
 * the {@link ode.FirstOrderDifferentialEquations
 ...
 * {@link ode.FirstOrderIntegrator#integrate
 ...
 * ode.sampling.StepHandler StepHandler} interface or a
 * {@link ode.sampling.StepNormalizer StepNormalizer}
 * object wrapping a user-specified object implementing the {@link
 * ode.sampling.FixedStepHandler FixedStepHandler}
 * interface into the integrator before calling the {@link
 * ode.FirstOrderIntegrator#integrate
 ...
 *
 * <p>
 * {@link ode.ContinuousOutputModel
 ...
 * ode.sampling.StepHandler StepHandler} interface are
 * available for general needs ({@link
 * ode.sampling.DummyStepHandler DummyStepHandler}, {@link
 * ode.sampling.StepNormalizer StepNormalizer}) and custom
 ...
 * ode.sampling.StepNormalizer StepNormalizer} class can
 ...
 * <tr><td>{@link ode.nonstiff.EulerIntegrator Euler}</td><td>1</td></tr>
 * <tr><td>{@link ode.nonstiff.MidpointIntegrator Midpoint}</td><td>2</td></tr>
 * <tr><td>{@link ode.nonstiff.ClassicalRungeKuttaIntegrator Classical Runge-Kutta}</td><td>4</td></tr>
 * <tr><td>{@link ode.nonstiff.GillIntegrator Gill}</td><td>4</td></tr>
 * <tr><td>{@link ode.nonstiff.ThreeEighthesIntegrator 3/8}</td><td>4</td></tr>
 * <tr><td>{@link ode.nonstiff.LutherIntegrator Luther}</td><td>6</td></tr>
 * </table>
 * </p>
 *
 * <table border="1" align="center">
 ...
 * <tr><td>{@link ode.nonstiff.HighamHall54Integrator Higham and Hall}</td><td>5</td><td>4</td></tr>
 * <tr><td>{@link ode.nonstiff.DormandPrince54Integrator Dormand-Prince 5(4)}</td><td>5</td><td>4</td></tr>
 * <tr><td>{@link ode.nonstiff.DormandPrince853Integrator Dormand-Prince 8(5,3)}</td><td>8</td><td>5 and 3</td></tr>
 * <tr><td>{@link ode.nonstiff.GraggBulirschStoerIntegrator Gragg-Bulirsch-Stoer}</td><td>variable (up to 18 by default)</td><td>variable</td></tr>
 * <tr><td>{@link ode.nonstiff.AdamsBashforthIntegrator Adams-Bashforth}</td><td>variable</td><td>variable</td></tr>
 * <tr><td>{@link ode.nonstiff.AdamsMoultonIntegrator Adams-Moulton}</td><td>variable</td><td>variable</td></tr>
 * </table>
 * </p>
 *
 * <p>
 * In the table above, the {@link ode.nonstiff.AdamsBashforthIntegrator
 * Adams-Bashforth} and {@link ode.nonstiff.AdamsMoultonIntegrator
