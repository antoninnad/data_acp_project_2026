...
import math.distribution.IntegerDistribution;
import math.distribution.RealDistribution;
import math.exception.NotANumberException;
import math.exception.NotFiniteNumberException;
...
public class RandomDataImpl implements RandomData, Serializable {
    ...
    /**
     * Generates a random value from the {@link distribution.BetaDistribution Beta Distribution}.
    ...
    /**
     * Generates a random value from the {@link distribution.BinomialDistribution Binomial Distribution}.
     * This implementation uses {@link #nextInversionDeviate(RealDistribution) inversion}
     * to generate random values.
     *
    ...
    /**
     * Generates a random value from the {@link distribution.CauchyDistribution Cauchy Distribution}.
     * This implementation uses {@link #nextInversionDeviate(RealDistribution) inversion}
     * to generate random values.
     *
    ...
    /**
     * Generates a random value from the {@link distribution.ChiSquaredDistribution ChiSquare Distribution}.
     * This implementation uses {@link #nextInversionDeviate(RealDistribution) inversion}
     * to generate random values.
     *
    ...
    /**
     * Generates a random value from the {@link distribution.FDistribution F Distribution}.
     * This implementation uses {@link #nextInversionDeviate(RealDistribution) inversion}
     * to generate random values.
     *
     ...
     * {@link distribution.GammaDistribution Gamma Distribution}.</p>
     *
    ...
    /**
     * Generates a random value from the {@link distribution.HypergeometricDistribution Hypergeometric Distribution}.
    ...
    /**
     * Generates a random value from the {@link distribution.PascalDistribution Pascal Distribution}.
     * This implementation uses {@link #nextInversionDeviate(IntegerDistribution) inversion}
     * to generate random values.
     *
    ...
    /**
     * Generates a random value from the {@link distribution.TDistribution T Distribution}.
     * This implementation uses {@link #nextInversionDeviate(RealDistribution) inversion}
     * to generate random values.
     *
    ...
    /**
     * Generates a random value from the {@link distribution.WeibullDistribution Weibull Distribution}.
     * This implementation uses {@link #nextInversionDeviate(RealDistribution) inversion}
     * to generate random values.
     *
    ...
    /**
     * Generates a random value from the {@link distribution.ZipfDistribution Zipf Distribution}.
     * This implementation uses {@link #nextInversionDeviate(IntegerDistribution) inversion}
     * to generate random values.
     *
