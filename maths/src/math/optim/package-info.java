 ...
 *  {@link optim.nonlinear.scalar.GoalType#MINIMIZE minimize} or
 *  {@link optim.nonlinear.scalar.GoalType#MAXIMIZE maximize}
 *  a scalar function, called the
 *  {@link optim.nonlinear.scalar.ObjectiveFunction <em>objective
 *  function</em>}.
 *  <br/>
 ...
 *  {@link optim.nonlinear.scalar.LeastSquaresConverter
 *  convert} a (vector) model into a (scalar) objective function.
 * </p>
 *
 * <p>
 *  This package math.provides common functionality for the optimization algorithms.
 *  Abstract classes ({@link optim.BaseOptimizer} and
 *  {@link optim.BaseMultivariateOptimizer}) contain
 *  boiler-plate code for storing {@link optim.MaxEval
 *  evaluations} and {@link optim.MaxIter iterations}
 *  counters and a user-defined
 *  {@link optim.ConvergenceChecker convergence checker}.
 * </p>
 *
 * <p>
