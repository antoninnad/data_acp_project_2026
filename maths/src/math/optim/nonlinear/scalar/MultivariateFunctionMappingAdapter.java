...
import math.analysis.function.Logit;
import math.analysis.function.Sigmoid;
 ...
 * optimization.BaseMultivariateOptimizer#optimize(int,
 * MultivariateFunction, optimization.GoalType, double[])}
 ...
 * {@link optim.nonlinear.scalar.noderiv.SimplexOptimizer
 * SimplexOptimizer}.
 * A better solution is to use an optimizer that directly supports simple bounds like
 * {@link optim.nonlinear.scalar.noderiv.CMAESOptimizer
 * CMAESOptimizer} or
 * {@link optim.nonlinear.scalar.noderiv.BOBYQAOptimizer
 * BOBYQAOptimizer}.
