 ...
 */
package math.optim.nonlinear.vector.jacobian;
...
import math.optim.OptimizationData;
import math.optim.ConvergenceChecker;
import math.optim.PointVectorValuePair;
import math.optim.nonlinear.vector.Weight;
import math.optim.nonlinear.vector.JacobianMultivariateVectorOptimizer;
 ...
 *
 * @since 3.1
 * @deprecated All classes and interfaces in this package math.are deprecated.
 * The optimizers that were provided here were moved to the
 * {@link fitting.leastsquares} package
 * (cf. MATH-1008).
 */
@Deprecated
public abstract class AbstractLeastSquaresOptimizer
     ...
     * <ul>
     *  <li>{@link optim.nonlinear.vector.Weight}</li>
     * </ul>
     * @return {@inheritDoc}
