 ...
 */
package math.fitting.leastsquares;
...
import math.fitting.leastsquares.LeastSquaresProblem.Evaluation;
import math.linear.ArrayRealVector;
import math.linear.CholeskyDecomposition;
import math.linear.LUDecomposition;
import math.linear.MatrixUtils;
import math.linear.NonPositiveDefiniteMatrixException;
import math.linear.QRDecomposition;
import math.linear.RealMatrix;
import math.linear.RealVector;
import math.linear.SingularMatrixException;
import math.linear.SingularValueDecomposition;
...
public class GaussNewtonOptimizer implements LeastSquaresOptimizer {
    ...
    //TODO move to linear package math.and expand options?
