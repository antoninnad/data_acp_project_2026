 ...
 */
package math.stat.inference;

import java.util.Collection;

import math.distribution.RealDistribution;
import math.exception.ConvergenceException;
import math.exception.DimensionMismatchException;
import math.exception.InsufficientDataException;
import math.exception.MaxCountExceededException;
import math.exception.NoDataException;
import math.exception.NotPositiveException;
import math.exception.NotStrictlyPositiveException;
...
import math.exception.ZeroException;
import math.stat.descriptive.StatisticalSummary;
...
public class TestUtils  {
    ...
    /**
     * @see stat.inference.TTest#homoscedasticT(double[], double[])
     */
    ...
    /**
     * @see stat.inference.TTest#homoscedasticT(stat.descriptive.StatisticalSummary, stat.descriptive.StatisticalSummary)
     */
    ...
    /**
     * @see stat.inference.TTest#homoscedasticTTest(double[], double[], double)
     */
    ...
    /**
     * @see stat.inference.TTest#homoscedasticTTest(double[], double[])
     */
    ...
    /**
     * @see stat.inference.TTest#homoscedasticTTest(stat.descriptive.StatisticalSummary, stat.descriptive.StatisticalSummary)
     */
    ...
    /**
     * @see stat.inference.TTest#pairedT(double[], double[])
     */
    ...
    /**
     * @see stat.inference.TTest#pairedTTest(double[], double[], double)
     */
    ...
    /**
     * @see stat.inference.TTest#pairedTTest(double[], double[])
     */
    ...
    /**
     * @see stat.inference.TTest#t(double, double[])
     */
    ...
    /**
     * @see stat.inference.TTest#t(double, stat.descriptive.StatisticalSummary)
     */
    ...
    /**
     * @see stat.inference.TTest#t(stat.descriptive.StatisticalSummary, stat.descriptive.StatisticalSummary)
     */
    ...
    /**
     * @see stat.inference.TTest#tTest(double, double[], double)
     */
    ...
    /**
     * @see stat.inference.TTest#tTest(double, double[])
     */
    ...
    /**
     * @see stat.inference.TTest#tTest(double, stat.descriptive.StatisticalSummary, double)
     */
    ...
    /**
     * @see stat.inference.TTest#tTest(double, stat.descriptive.StatisticalSummary)
     */
    ...
    /**
     * @see stat.inference.TTest#tTest(stat.descriptive.StatisticalSummary, stat.descriptive.StatisticalSummary, double)
     */
    ...
    /**
     * @see stat.inference.TTest#tTest(stat.descriptive.StatisticalSummary, stat.descriptive.StatisticalSummary)
     */
    ...
    /**
     * @see stat.inference.ChiSquareTest#chiSquare(double[], long[])
     */
    ...
    /**
     * @see stat.inference.ChiSquareTest#chiSquare(long[][])
     */
    ...
    /**
     * @see stat.inference.ChiSquareTest#chiSquareTest(double[], long[], double)
     */
    ...
    /**
     * @see stat.inference.ChiSquareTest#chiSquareTest(double[], long[])
     */
    ...
    /**
     * @see stat.inference.ChiSquareTest#chiSquareTest(long[][], double)
     */
    ...
    /**
     * @see stat.inference.ChiSquareTest#chiSquareTest(long[][])
     */
    ...
    /**
     * @see stat.inference.ChiSquareTest#chiSquareDataSetsComparison(long[], long[])
     *
     * @since 1.2
     */
    ...
    /**
     * @see stat.inference.ChiSquareTest#chiSquareTestDataSetsComparison(long[], long[])
     *
     * @since 1.2
     */
    ...
    /**
     * @see stat.inference.ChiSquareTest#chiSquareTestDataSetsComparison(long[], long[], double)
     *
     * @since 1.2
     */
    ...
    /**
     * @see stat.inference.OneWayAnova#anovaFValue(Collection)
     *
     * @since 1.2
     */
    ...
    /**
     * @see stat.inference.OneWayAnova#anovaPValue(Collection)
     *
     * @since 1.2
     */
    ...
    /**
     * @see stat.inference.OneWayAnova#anovaTest(Collection,double)
     *
     * @since 1.2
     */
    public static boolean oneWayAnovaTest(final Collection<double[]> categoryData,
     ...
     /**
     * @see stat.inference.GTest#g(double[], long[])
     * @since 3.1
     */
    ...
    /**
     * @see stat.inference.GTest#gTest( double[],  long[] )
     * @since 3.1
     */
    ...
    /**
     * @see stat.inference.GTest#gTestIntrinsic(double[], long[] )
     * @since 3.1
     */
    public static double gTestIntrinsic(final double[] expected, final long[] observed)
     ...
     /**
     * @see stat.inference.GTest#gTest( double[],long[],double)
     * @since 3.1
     */
    ...
    /**
     * @see stat.inference.GTest#gDataSetsComparison(long[], long[])
     * @since 3.1
     */
    ...
    /**
     * @see stat.inference.GTest#rootLogLikelihoodRatio(long, long, long, long)
     * @since 3.1
     */
    ...
    /**
     * @see stat.inference.GTest#gTestDataSetsComparison(long[], long[])
     * @since 3.1
     */
    ...
    /**
     * @see stat.inference.GTest#gTestDataSetsComparison(long[],long[],double)
     * @since 3.1
     */
    ...
    /**
     * @see stat.inference.KolmogorovSmirnovTest#kolmogorovSmirnovStatistic(RealDistribution, double[])
     * @since 3.3
     */
    ...
    /**
     * @see stat.inference.KolmogorovSmirnovTest#kolmogorovSmirnovTest(RealDistribution, double[])
     * @since 3.3
     */
    ...
    /**
     * @see stat.inference.KolmogorovSmirnovTest#kolmogorovSmirnovTest(RealDistribution, double[], boolean)
     * @since 3.3
     */
    ...
    /**
     * @see stat.inference.KolmogorovSmirnovTest#kolmogorovSmirnovTest(RealDistribution, double[], double)
     * @since 3.3
     */
    ...
    /**
     * @see stat.inference.KolmogorovSmirnovTest#kolmogorovSmirnovStatistic(double[], double[])
     * @since 3.3
     */
    ...
    /**
     * @see stat.inference.KolmogorovSmirnovTest#kolmogorovSmirnovTest(double[], double[])
     * @since 3.3
     */
    ...
    /**
     * @see stat.inference.KolmogorovSmirnovTest#kolmogorovSmirnovTest(double[], double[], boolean)
     * @since 3.3
     */
    ...
    /**
     * @see stat.inference.KolmogorovSmirnovTest#exactP(double, int, int, boolean)
     * @since 3.3
     */
    ...
    /**
     * @see stat.inference.KolmogorovSmirnovTest#approximateP(double, int, int)
     * @since 3.3
     */
    ...
    /**
     * @see stat.inference.KolmogorovSmirnovTest#monteCarloP(double, int, int, boolean, int)
     * @since 3.3
     */
