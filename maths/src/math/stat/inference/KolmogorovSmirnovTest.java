...
import math.distribution.EnumeratedRealDistribution;
import math.distribution.RealDistribution;
import math.distribution.UniformRealDistribution;
import math.exception.InsufficientDataException;
import math.exception.MathArithmeticException;
import math.exception.MathInternalError;
...
import math.exception.TooManyIterationsException;
import math.exception.util.LocalizedFormats;
import math.fraction.BigFraction;
import math.fraction.BigFractionField;
import math.fraction.FractionConversionException;
import math.linear.Array2DRowFieldMatrix;
import math.linear.FieldMatrix;
...
import math.random.Well19937c;
import math.util.CombinatoricsUtils;
 ...
 * in the R Matching package math.[3], can be used if ties are known to be present in the data.
 * </p>
 * <p>
 ...
 * The Matching package math.for R</a> Journal of Statistical Software, 42(7): 1-52.</li>
...
public class KolmogorovSmirnovTest {
     ...
     * Software with Automated Balance Optimization: The Matching package math.for R.'
     ...
     * package math.function. See #bootstrap(double[], double[], int, boolean).
     *
     * @param x first sample
     * @param y second sample
     * @param iterations number of bootstrap resampling iterations
     ...
     * {@code double} rather than {@link fraction.BigFraction}.
     *
     * @param d statistic
     * @param n sample size
     * @return \(P(D_n < d)\)
     * @throws MathArithmeticException if algorithm fails to convert {@code h} to a
     *         {@link fraction.BigFraction} in expressing {@code d} as \((k
     ...
     *        {@link fraction.BigFraction} everywhere at the expense of
     ...
     * in class javadoc above) and {@link fraction.BigFraction} (see
     * above).
     *
     * @param d statistic
     * @param n sample size
