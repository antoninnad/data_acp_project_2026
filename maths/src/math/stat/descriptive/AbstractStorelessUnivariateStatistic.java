...
public abstract class AbstractStorelessUnivariateStatistic
     ...
     * @see stat.descriptive.UnivariateStatistic#evaluate(double[])
     */
    @Override
     ...
     * @see stat.descriptive.UnivariateStatistic#evaluate(double[], int, int)
     */
    @Override
     ...
     * @throws MathIllegalArgumentException if values is null
     * @see stat.descriptive.StorelessUnivariateStatistic#incrementAll(double[])
     */
     ...
     * @throws MathIllegalArgumentException if values is null
     * @see stat.descriptive.StorelessUnivariateStatistic#incrementAll(double[], int, int)
     */
